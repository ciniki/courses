...
/*    $sections['ciniki.courses.course'] = array(
    ...
    $sections['ciniki.courses.upcoming'] = [
        ...
        'settings' => [
            ...
            'offering-image-position'=>['label'=>'Session Image Position', 'type'=>'select', 'default'=>'top-right', 'separator'=>'yes', 'options'=>[
                'top-left' => 'Top Left',
            ...
            'offering-image-size'=>['label'=>'Session Image Size', 'type'=>'toggle', 'default'=>'half', 'toggles'=>[
                'half' => 'Full',
                'large' => 'Large',
                'medium' => 'Medium',
                'small' => 'Small',
