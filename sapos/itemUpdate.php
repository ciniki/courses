...
// =======
//
function ciniki_courses_sapos_itemUpdate($ciniki, $business_id, $invoice_id, $item) {
	...
	if( isset($item['object']) && $item['object'] == 'ciniki.courses.offering_registration' && isset($item['object_id']) ) {
		...
		if( !isset($rc['registration']) ) {
			return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1512', 'msg'=>'Unable to find course registration'));
		}
