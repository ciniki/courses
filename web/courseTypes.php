...
function ciniki_courses_web_courseTypes($ciniki, $settings, $tnid) {
    ...
    $strsql = "SELECT DISTINCT ciniki_courses.type "
        ...
        . "INNER JOIN ciniki_courses ON ("
            ...
            . ") "
        . "INNER JOIN ciniki_course_offering_classes ON ("
            . "ciniki_course_offerings.id = ciniki_course_offering_classes.offering_id ";
    if( !isset($settings['page-courses-past-active']) || $settings['page-courses-past-active'] == 'no' ) {
        $strsql .= "AND ciniki_course_offering_classes.class_date > NOW() ";
    }
    $strsql .= "AND ciniki_course_offering_classes.tnid = '" . ciniki_core_dbQuote($ciniki, $tnid) . "' "
            . ") "
...
//    $strsql .= "GROUP BY ciniki_course_offerings.id "
//        . "";
