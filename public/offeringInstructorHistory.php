...
function ciniki_courses_offeringInstructorHistory($ciniki) {
    ...
    $rc = ciniki_courses_checkAccess($ciniki, $args['tnid'], 'ciniki.courses.offeringInstructorHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.courses', 'ciniki_course_history', 
        $args['tnid'], 'ciniki_course_offering_instructors', $args['offering_instructor_id'], $args['field']);
}
?>
