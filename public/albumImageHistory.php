...
function ciniki_courses_albumImageHistory($ciniki) {
    ...
    $rc = ciniki_courses_checkAccess($ciniki, $args['tnid'], 'ciniki.courses.albumImageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.courses', 'ciniki_courses_history', $args['tnid'], 'ciniki_course_album_images', $args['albumimage_id'], $args['field']);
}
?>
