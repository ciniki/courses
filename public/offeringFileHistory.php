...
function ciniki_courses_offeringFileHistory($ciniki) {
	...
	$rc = ciniki_courses_checkAccess($ciniki, $args['business_id'], 'ciniki.courses.offeringFileHistory');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.courses', 'ciniki_course_history', 
		$args['business_id'], 'ciniki_course_offering_files', $args['offering_file_id'], $args['field']);
}
?>
