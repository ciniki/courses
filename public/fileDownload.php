...
function ciniki_courses_fileDownload($ciniki) {
	...
	if( !isset($rc['file']) ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1273', 'msg'=>'Unable to find file'));
	}
	...
	if( $rc['file']['extension'] == 'pdf' ) {
		...
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1274', 'msg'=>'Unsupported file type'));
	}
	// Specify Filename
