...
function ciniki_courses_fileDelete(&$ciniki) {
    ...
    $rc = ciniki_courses_checkAccess($ciniki, $args['tnid'], 'ciniki.courses.fileDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.courses.file', $args['file_id'], $uuid, 0x07);
}
?>
